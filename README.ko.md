...
| [atlassian](plugins/atlassian) | Claude에서 Jira·Confluence — 이슈·페이지 본문을 납작한 ADF가 아니라 충실한 Markdown으로 |

> Deprecated된 플러그인은 [plugins/deprecated/](plugins/deprecated)에 보관됩니다 — 마켓플레이스에서 제거되어 설치할 수 없습니다.
